    ...
    *,
    ...
    if force_primary:
        ...
        return ModelRoute(
            ...
            tier="primary",
            reason=(
                "Primary model explicitly requested."
                if escalated
                else "Primary model explicitly retained."
            ),
            escalated=escalated,
        )
    ...
    if attempt > 1:
        ...
        return ModelRoute(
            ...
            tier="primary",
            reason=(
                f"{agent} already uses the primary "
                f"model; retained for attempt "
                f"{attempt}."
            ),
            escalated=False,
        )
